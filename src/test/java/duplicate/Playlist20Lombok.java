...
public class Playlist20Lombok {
    ...
    @JsonProperty("description")
    public Playlist20Lombok setDescription(String description) {
    ...
    @JsonProperty("name")
    public Playlist20Lombok setName(String name) {
        this.name = name;
        return this;
    }
    ...
    @JsonProperty("public")
    public Playlist20Lombok set_public(Boolean _public) {
