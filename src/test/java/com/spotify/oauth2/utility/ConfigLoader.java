...
public class ConfigLoader {
    ...
    public String getClientId(){
        ...
        else throw new RuntimeException("Property client_id is missing in the config.properties file");
    }

    public String getClientSecret(){
        String prop=properties.getProperty("client_secret");
        if(prop!=null) return prop;
        else throw new RuntimeException("Property client_secret is missing in the config.properties file");
    }
